...
?>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="../user/user-home.php">AniBox</a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../user/user-home.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../user/user-home.php#browse">Browse</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../user/user-profile-mybox.php">My Box</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../user/user-profile-about.php">Profile</a>
                    </li>
                </ul>
    ...
    <script src="anime-logout.js"></script>